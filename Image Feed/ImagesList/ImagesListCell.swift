...
final class ImagesListCell: UITableViewCell {
    ...
    private enum Constants {
        static let photoPlaceholder = "photo_placeholder"
    ...
    func setIsLiked(_ isLiked: Bool) {
        ...
        ? UIImage(named: Constants.likeButtonOn)
        : UIImage(named: Constants.likeButtonOff)
    ...
    private func setState(_ state: FeedCellImageState) {
        ...
        case .error:
            ...
            cellImage.image = UIImage(named: Constants.photoPlaceholder)
